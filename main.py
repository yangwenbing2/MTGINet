...
def main():
    ...
    if CONFIG.phase.lower() == "train":
        ...
        # Create a dataloader
        train_image_file = ImageFileTrain(image_dir=CONFIG.data.train_image,
        ...
        test_image_file = ImageFileTest(image_dir=CONFIG.test.image,
                                        alpha_dir=CONFIG.test.alpha,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='config/b1_HHM-17K.toml')
