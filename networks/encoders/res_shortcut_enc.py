...
class ResShortCut_D(ResNet_D):
    ...
    def forward(self, x):
        ...
        fea1 = self.shortcut[0](x)      # N  x 32 x 512 x 512
        fea2 = self.shortcut[1](x1)     # N  x 32 x 256 x 256
        ...
        # fea2, fea3, fea4, fea5 = x1, x2, x3, x4

        return out, {'shortcut': (fea1, fea2, fea3, fea4, fea5), 'image': x}
